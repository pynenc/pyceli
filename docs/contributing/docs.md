# Documentation Setup for Piceli

This directory contains the Sphinx documentation for Piceli. To build the documentation, you need to install the necessary dependencies using Poetry and then use Sphinx to build the documentation.
